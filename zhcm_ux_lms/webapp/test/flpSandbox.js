		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Eğitim Yönetim Modülü",
									"targetURL": "#zhcmuxlmszhcmuxlms-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zhcmuxlmszhcmuxlms-display": {
								"semanticObject": "zhcmuxlmszhcmuxlms",
								"action": "display",
								"description": "Eğitim Yönetim Modülü",
								"title": "Eğitim Yönetim Modülü",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zhcm_ux_lms_abr",
									"url": sap.ui.require.toUrl("zhcm_ux_lms_abr")
								}
							}
						}
					}
