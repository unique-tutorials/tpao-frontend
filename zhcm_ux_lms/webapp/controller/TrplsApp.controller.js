  ...
  function (
    ...
    return BaseController.extend("zhcm_ux_lms_abr.controller.TrplsApp", {
      ...
      onNavBack: function () {
        ...
        var aPaths = ["/newNumberReserRequest", "/reservationEmployee"];
      ...
      onSearchs: function (oEvent) {
        ...
        var oTable =
          this.getView().byId("reservationTable") ||
          sap.ui.getCore().byId("reservationTable");
      ...
      onItemSelected: function (oEvent) {
        ...
        var oSelectedItem = oEvent
          .getSource()
          .getBindingContext("trplsRequestListModel")
          .getObject();

        var oViewModel = this.getModel("trplsRequestListModel");
        oViewModel.setProperty(
          "/newNumberReserRequest/Rezno",
          oSelectedItem.Rezno
        );
        oViewModel.setProperty(
          "/newNumberReserRequest/Pernr",
          oSelectedItem.Pernr
        );
        oViewModel.setProperty(
          "/newNumberReserRequest/Ename",
      ...
      onShowReservationSearchHelp: function (oEvent) {
        if (!this._oReserSearchHelpDialog) {
          this._oReserSearchHelpDialog = sap.ui.xmlfragment(
            "zhcm_ux_lms_abr.fragment.TrplsApp.ReservationSearchHelpDialog",
            this
          );
      ...
      onReservationSendMailButton: function (oEvent) {
        ...
        var sPernr = oViewModel.getProperty("/reservationEmployee/Pernr"),
          ...
          sEnoda = oViewModel.getProperty("/reservationEmployee/Enoda"),
